...
public class cancelCardExecute {
    Socket socket;
    public cancelCardExecute(Socket socket){
        this.socket = socket;
    }
    ...
    public void start(){
        try {
            ...
            if(searchCard == null){
                ...
                result = 3;
            }else if(searchCard.getStatus() == 2 || searchCard.getStatus() == 3){
                result = 2;
            }else{
                result = carddao.cancel(cardNumber);
            }
