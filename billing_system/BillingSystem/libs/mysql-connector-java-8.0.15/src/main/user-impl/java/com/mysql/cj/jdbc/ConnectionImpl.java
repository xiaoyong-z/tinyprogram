...
public class ConnectionImpl implements JdbcConnection, SessionEventListener, Serializable {
    ...
    /** Properties for this connection specified by userDao */
    ...
    /** The userDao we're connected as */
     ...
     * 
     * @param hostInfo
     *            the {@link HostInfo} instance that contains the host, userDao and connections attributes for this connection
    ...
    public ConnectionImpl(HostInfo hostInfo) throws SQLException {
        ...
        try {
            ...
            // we can't cache fixed values here because properties are still not initialized with userDao provided values
    ...
    public boolean isSameResource(JdbcConnection otherConnection) {
        synchronized (getConnectionMutex()) {
            ...
            // Has the userDao explicitly set a resourceId?
