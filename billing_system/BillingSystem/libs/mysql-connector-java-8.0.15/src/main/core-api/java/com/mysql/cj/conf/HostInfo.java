 ...
 * <li>userDao info: a structure containing the userDao name and password.
...
public class HostInfo implements DatabaseUrlContainer {
    ...
    /**
     * Constructs a {@link HostInfo} instance initialized with the provided host, port and userDao info.
     * 
     * @param url
    ...
    /**
     * Constructs a {@link HostInfo} instance initialized with the provided host, port, userDao, password and connection arguments.
     * 
     * @param url
     *            a reference to the original database URL that produced this host info
     * @param host
    ...
    /**
     * Returns the userDao name.
     * 
     * @return the userDao name
     */
    ...
    /**
     * Exposes this host info as a single properties instance. The values for host, port, userDao and password are added to the properties map with their standard
     * keys.
     * 
    ...
    public String toString() {
        ...
        asStr.append(String.format(" :: {host: \"%s\", port: %d, userDao: %s, password: %s, hostProperties: %s}", this.host, this.port, this.user, this.password,
                this.hostProperties));
