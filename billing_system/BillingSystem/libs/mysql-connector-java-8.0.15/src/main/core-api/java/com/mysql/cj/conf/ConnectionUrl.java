...
public abstract class ConnectionUrl implements DatabaseUrlContainer {
    ...
    /**
     * Returns the default userDao. Usually the one provided in the method {@link DriverManager#getConnection(String, String, String)} or as connection argument.
     * 
     * @return the default userDao
     */
