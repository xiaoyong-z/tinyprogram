 ...
 * 
 * QueryInterceptors are "chainable" when configured by the userDao, the results returned by the "current" interceptor will be passed on to the next on in the
 * chain, from left-to-right order, as specified by the userDao in the driver configuration property "queryInterceptors".
 */
