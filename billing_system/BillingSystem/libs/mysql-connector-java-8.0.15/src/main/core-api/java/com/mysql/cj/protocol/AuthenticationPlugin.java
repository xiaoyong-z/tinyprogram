...
public interface AuthenticationPlugin<M extends Message> {
     ...
     * call. Values of userDao and password parameters are passed from
     * those in MysqlIO.changeUser(String userName, String password,
     * String database) or MysqlIO.doHandshake(String userDao, String
     ...
     * saves userDao and password into connection only after successful
     * handshake.
     * 
     * @param user
     *            userDao name
