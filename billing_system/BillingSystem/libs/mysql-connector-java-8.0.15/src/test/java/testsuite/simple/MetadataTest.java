    ...
    public void testGetColumnPrivilegesUsingInfoSchema() throws Exception {
        ...
        if (!runTestIfSysPropDefined(PropertyDefinitions.SYSP_testsuite_cantGrant)) {
            ...
            try {
                ...
                if (userHost.size() < 2) {
                    fail("This test requires a JDBC URL with a userDao, and won't work with the anonymous userDao. "
                ...
                try {
                    ...
                    fail("This testcase needs to be run with a URL that allows the userDao to issue GRANTs "
