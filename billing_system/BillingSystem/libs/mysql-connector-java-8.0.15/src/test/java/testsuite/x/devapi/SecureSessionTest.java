...
public class SecureSessionTest extends DevApiBaseTestCase {
    ...
    public void testAuthMechanisms() throws Throwable {
        ...
        try {
             ...
             */
            String accessDeniedErrMsg = "ERROR 1045 \\(HY000\\) Invalid userDao or password";
            ...
            if (mysqlVersionMeetsMinimum(ServerVersion.parseVersion("8.0.3"))) {
                ...
                if (mysqlVersionMeetsMinimum(ServerVersion.parseVersion("8.0.12"))) {
                    accessDeniedErrMsg = "ERROR 1045 \\(HY000\\) Access denied for userDao 'testAuthMechSha256'@.*";
                }
            ...
            if (mysqlVersionMeetsMinimum(ServerVersion.parseVersion("8.0.3"))) {
                ...
                props.setProperty(PropertyKey.xdevapiAuth.getKeyName(), "MYSQL41");
                if (mysqlVersionMeetsMinimum(ServerVersion.parseVersion("8.0.12"))) {
                    accessDeniedErrMsg = "ERROR 1045 \\(HY000\\) Access denied for userDao 'testAuthMechCachingSha2'@.*";
                }
     ...
     * -Dcom.mysql.cj.testsuite.mysqlx.url=mysqlx://localhost:33060/cjtest_5_1?userDao=root&password=pwd
     * -Dcom.mysql.cj.testsuite.mysqlx.url.openssl=mysqlx://localhost:33070/cjtest_5_1?userDao=root&password=pwd
     */
    @Test
    ...
    public void testBug27629553() {
        ...
        props.setProperty("userDao", "testBug27629553");
