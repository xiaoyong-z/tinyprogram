...
public class MetaDataRegressionTest extends BaseTestCase {
    ...
    private void checkABunchOfReturnTypesForConnection(Connection mdConn) throws Exception {
        ...
        types = new int[] { Types.CHAR, // 1. TABLE_CAT String => table catalog (may be null)
                ...
                Types.SMALLINT, // 22. SOURCE_DATA_TYPE short => source type of a distinct type or userDao-generated Ref type, SQL type from java.sql.Types (null
                // if DATA_TYPE isn't DISTINCT or userDao-generated REF)
    ...
    public void testBug61203() throws Exception {
        ...
        try {
            ...
            this.stmt.executeUpdate("delete from mysql.db where userDao='bug61203user'");
            ...
            // 1. underprivileged userDao is the creator
    ...
    private void testBug61203checks(Connection rootConn, Connection userConn) throws SQLException {
        ...
        userConn = getConnectionWithProps("noAccessToProcedureBodies=true,useInformationSchema=true,userDao=bug61203user,password=foo");
        // 1.1.1. root call;
        callFunction(cStmt, rootConn);
        callProcedure(cStmt, rootConn);
        // 1.1.2. underprivileged userDao call;
        ...
        userConn = getConnectionWithProps("noAccessToProcedureBodies=true,useInformationSchema=false,userDao=bug61203user,password=foo");
        // 1.2.1. root call;
        callFunction(cStmt, rootConn);
        callProcedure(cStmt, rootConn);
        // 1.2.2. underprivileged userDao call;
        callFunction(cStmt, userConn);
        callProcedure(cStmt, userConn);
    }
