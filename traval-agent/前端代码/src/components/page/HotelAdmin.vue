    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item>
                    <i class="el-icon-lx-cascades"></i> 酒店管理
                </el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
            ...
            >
                <el-table-column prop="name" label="酒店名" align="center"></el-table-column>
                <el-table-column prop="address" label="酒店地址" align="center"></el-table-column>
                <el-table-column prop="phone_number" label="酒店电话" align="center"></el-table-column>
...
<script>
    ...
    export default {
        ...
        methods: {
            // 获取 easy-mock 的模拟数据
            getData() {
                this.axios.get(this.GLOBAL.hotel_get).then((res)=>{
            ...
            handleDelete(index, row) {
                ...
                this.$confirm('确定要删除吗？', '提示', {
                    ...
                    .then(() => {
                        ...
                        this.axios.delete(this.GLOBAL.hotel_delete,
                            {
                                data: deleteData,
                                headers: {
            ...
            saveEdit() {
                ...
                this.axios.patch(this.GLOBAL.hotel_update, patchData).then((res)=>{
                    console.log(res);
                }).catch((res)=>{
                    console.log(res);
                });
            ...
            async saveAdd(){
                ...
                await this.axios.post(this.GLOBAL.hotel_add, postData).then((res)=>{
                    console.log(res);
                }).catch((res)=>{
                    console.log(res);
                });
