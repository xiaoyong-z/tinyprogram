    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item>
                    <i class="el-icon-lx-cascades"></i> 美食管理
                </el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
            <div class="handle-box">
                ...
                <el-input v-model="query.name" placeholder="美食名" class="handle-input mr10"></el-input>
            </div>
            <el-table
                    :data="currentList"
                    border
            ...
            >
                <el-table-column prop="name" label="美食名" align="center" width="100"></el-table-column>
                <el-table-column prop="description" label="美食描述" align="center"></el-table-column>
...
<script>
    ...
    export default {
        ...
        methods: {
            // 获取 easy-mock 的模拟数据
            getData() {
                this.axios.get(this.GLOBAL.food_get).then((res)=>{
            ...
            handleDelete(index, row) {
                ...
                this.$confirm('确定要删除吗？', '提示', {
                    ...
                    .then(() => {
                        ...
                        this.axios.delete(this.GLOBAL.food_delete,
                            {
                                data: deleteData,
                                headers: {
            ...
            async saveAdd(){
                ...
                await this.axios.post(this.GLOBAL.food_add, postData).then((res)=>{
                    console.log(res);
                }).catch((res)=>{
            console.log(res);
            });
