<template>
    <div>
        ...
        <div class="container">
            ...
            >
                <el-table-column prop="name" label="景点名" align="center" width="100"></el-table-column>
                <el-table-column prop="description" label="景点描述" align="center"></el-table-column>
...
<script>
    ...
    export default {
        ...
        methods: {
            // 获取 easy-mock 的模拟数据
            getData() {
                this.axios.get(this.GLOBAL.scenic_get).then((res)=>{
            ...
            handleDelete(index, row) {
                ...
                this.$confirm('确定要删除吗？', '提示', {
                    ...
                    .then(() => {
                        ...
                        this.axios.delete(this.GLOBAL.scenic_delete,
                            {
                                data: deleteData,
                                headers: {
            ...
            saveEdit() {
                ...
                let patchData = this.$qs.stringify({
                    scenic_id: this.form.scenic_id,
                    name: this.form.name,
                    description: this.form.description,
                });
                this.axios.patch(this.GLOBAL.scenic_update, patchData).then((res)=>{
                    console.log(res);
                }).catch((res)=>{
                    console.log(res);
                });
            ...
            async saveAdd(){
                ...
                await this.axios.post(this.GLOBAL.scenic_add, postData).then((res)=>{
                    console.log(res);
                }).catch((res)=>{
                    console.log(res);
                });
