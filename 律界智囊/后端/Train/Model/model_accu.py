...
class F1ScoreCallback(keras.callbacks.Callback):
    def __init__(self, valid_data, predict_batch_size=512):
        super(F1ScoreCallback, self).__init__()
        self.predict_batch_size = predict_batch_size
        self.include_on_batch = False
    ...
    def on_epoch_end(self, epoch, logs={}):
        ...
        if (self.validation_data):
            ...
            logs['f1_score_macro_val'] = f1
            logs['f1_score_micro_val'] = f2
...
for i in range(epochs):
    ...
    model.save(config.get("save", "save_path") + 'epochs_%d.h5' % i)
